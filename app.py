...
def main():
    ...
    with col2:
        st.markdown(
            ...
            "لا يجب الاعتماد عليه وقد يكون خطأ ويجب النظر ومتابعة الحركة السعرية "
        )
